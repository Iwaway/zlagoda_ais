...
routes.get(API_ROOT + '/employee/:id_employee', auth.authorizeManager, employee.getById)
routes.post(API_ROOT + '/employee/create', auth.authorizeManager, employee.create)
routes.put(API_ROOT + '/employee/update/:id_employee', auth.authorizeManager, employee.update)
routes.delete(API_ROOT + '/employee/delete/:id_employee', auth.authorizeManager, employee.deleteById)
...
routes.get(API_ROOT + '/role/:role_id', role.getById)
...
routes.get(API_ROOT + '/customerBySurname', auth.authorizeCashier, customer.getBySurname)

//Додавати, редагувати, видаляти дані про товари
routes.get(API_ROOT + '/customer/:card_number', auth.authorizeManager, customer.getById)
routes.post(API_ROOT + '/customer/create', auth.authorizeCashierOrManager, customer.create)
routes.put(API_ROOT + '/customer/update/:card_number', auth.authorizeCashierOrManager, customer.update)
routes.delete(API_ROOT + '/api/customer/delete/:card_number', auth.authorizeManager, customer.deleteById)
...
routes.get(API_ROOT + '/storeProduct/:upc', auth.authorizeCashier, store_product.getById)

//За UPC-товару знайти ціну продажу товару, кількість наявних одиниць товару, назву та характеристики товару
routes.get(API_ROOT + '/storeProduct/:upc', auth.authorizeManager, store_product.getByIdAll)

//Додавати, редагувати, видаляти дані про товари у магазині
routes.get(API_ROOT + '/storeProduct/:upc', store_product.getById)
routes.post(API_ROOT + '/storeProduct/create', auth.authorizeManager, store_product.create)
routes.put(API_ROOT + '/storeProduct/update/:upc', auth.authorizeManager, store_product.update)
routes.delete(API_ROOT + '/storeProduct/delete/:upc', auth.authorizeManager, store_product.deleteById)
